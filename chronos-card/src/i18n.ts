...
const STRINGS: Record<string, Record<BaseLang, string>> = {
  ...
  "nav.weather_rules": { it: "Regole", en: "Rules", fr: "Règles", de: "Regeln" },
  ...
  "screen.weather_rule.title": { it: "Regola", en: "Rule", fr: "Règle", de: "Regel" },
  ...
  // Disable-confirmation modal (Settings > Safety > confirm_disable)
  "modal.disable.title": { it: "Disattivare?", en: "Turn off?", fr: "Désactiver ?", de: "Deaktivieren?" },
  "modal.disable.body": { it: "Questa schedulazione smetterà di eseguire i suoi blocchi finché non la riattivi.", en: "This schedule will stop running its blocks until you turn it back on.", fr: "Cette planification cessera d'exécuter ses blocs jusqu'à ce que tu la réactives.", de: "Dieser Zeitplan führt seine Blöcke nicht mehr aus, bis du ihn wieder aktivierst." },
  "modal.disable.body_rule": { it: "Questa regola smetterà di agire su tutte le schedulazioni a cui è assegnata.", en: "This rule will stop acting on every schedule it is assigned to.", fr: "Cette règle cessera d'agir sur toutes les planifications auxquelles elle est affectée.", de: "Diese Regel wirkt nicht mehr auf alle Zeitpläne, denen sie zugewiesen ist." },
  "modal.disable.hint": { it: "Puoi disattivare questa richiesta di conferma in Impostazioni → Sicurezza.", en: "You can turn this confirmation off in Settings → Safety.", fr: "Tu peux désactiver cette confirmation dans Réglages → Sécurité.", de: "Du kannst diese Rückfrage unter Einstellungen → Sicherheit abschalten." },
  ...
  "overview.kpi.weather_rules": { it: "Regole", en: "Rules", fr: "Règles", de: "Regeln" },
  ...
  "editor.auto_off.label": { it: "Spegni da solo dopo", en: "Auto-off after", fr: "Arrêt automatique après", de: "Automatisch ausschalten nach" },
  "editor.auto_off.hint": { it: "Chronos spegne i dispositivi del blocco N minuti dopo l'accensione. Vuoto = disattivato. Sopravvive ai riavvii: se HA riparte a timer in corso, lo spegnimento avviene al riavvio", en: "Chronos switches the block's devices off N minutes after turning them on. Empty = disabled. Restart-safe: if HA restarts mid-timer, the switch-off happens at startup", fr: "Chronos éteint les appareils du bloc N minutes après l'allumage. Vide = désactivé. Résiste aux redémarrages : si HA redémarre pendant le minuteur, l'arrêt a lieu au démarrage", de: "Chronos schaltet die Geräte des Blocks N Minuten nach dem Einschalten aus. Leer = deaktiviert. Neustartsicher: startet HA währenddessen neu, erfolgt die Abschaltung beim Start" },
  "load.retry.hint": { it: "L'integrazione potrebbe essere ancora in avvio: riprovo automaticamente…", en: "The integration may still be starting: retrying automatically…", fr: "L'intégration démarre peut-être encore : nouvelle tentative automatique…", de: "Die Integration startet möglicherweise noch: automatischer neuer Versuch…" },
  ...
  "editor.irrigation.mode": { it: "Gestione durata valvole", en: "Valve duration mode", fr: "Mode de durée des vannes", de: "Ventil-Dauermodus" },
  "editor.irrigation.mode.global": { it: "Durata globale", en: "Global duration", fr: "Durée globale", de: "Globale Dauer" },
  "editor.irrigation.mode.sequential": { it: "Sequenza per valvola", en: "Per-valve sequence", fr: "Séquence par vanne", de: "Sequenz pro Ventil" },
  "editor.irrigation.seq.hint": { it: "Chronos apre le valvole una alla volta, ognuna per i minuti indicati, poi passa alla successiva. La durata totale del programma è la somma dei singoli tempi.", en: "Chronos opens the valves one at a time, each for the minutes set below, then moves to the next. Total program length is the sum of all the times.", fr: "Chronos ouvre les vannes une par une, chacune pour les minutes indiquées, puis passe à la suivante. La durée totale est la somme des temps.", de: "Chronos öffnet die Ventile nacheinander, jedes für die angegebenen Minuten, dann das nächste. Gesamtdauer = Summe aller Zeiten." },
  "editor.irrigation.seq.no_valves": { it: "Nessuna valvola collegata a questa schedulazione. Aggiungine almeno una dal selettore dispositivi.", en: "No valve linked to this schedule. Add at least one from the device picker.", fr: "Aucune vanne liée à cette planification. Ajoutes-en une depuis le sélecteur d'appareils.", de: "Kein Ventil mit diesem Zeitplan verknüpft. Füge mindestens eines über den Geräte-Selektor hinzu." },
  "editor.irrigation.seq.total": { it: "Durata totale programma:", en: "Total program length:", fr: "Durée totale du programme :", de: "Gesamtdauer des Programms:" },
  "settings.irrigation.title": { it: "Irrigazione", en: "Irrigation", fr: "Irrigation", de: "Bewässerung" },
  "settings.irrigation.conflict_block.title": { it: "Blocca salvataggio su conflitto valvole", en: "Block save on valve conflict", fr: "Bloquer l'enregistrement en cas de conflit de vanne", de: "Speichern bei Ventilkonflikt blockieren" },
  "settings.irrigation.conflict_block.desc": { it: "Se due programmi sequenziali si sovrappongono nel tempo e condividono la stessa valvola, impedisce di salvare (rischio pressione acqua). Se disattivato mostra solo un avviso e lasci decidere a te.", en: "If two sequential programs overlap in time and share the same valve, prevents saving (water-pressure hazard). When off, only a warning is shown and you decide.", fr: "Si deux programmes séquentiels se chevauchent dans le temps et partagent la même vanne, empêche l'enregistrement (risque de pression d'eau). Désactivé : seulement un avertissement.", de: "Wenn sich zwei sequentielle Programme zeitlich überschneiden und dasselbe Ventil teilen, wird das Speichern blockiert (Wasserdruck-Risiko). Aus: nur eine Warnung." },
  "editor.irrigation.conflict.warn": { it: "Attenzione: questo programma sequenziale si sovrappone nel tempo a un'altra schedulazione che usa la valvola {valve}. Avviarli insieme può causare problemi di pressione dell'acqua.", en: "Warning: this sequential program overlaps in time with another schedule using valve {valve}. Running them together can cause water-pressure problems.", fr: "Attention : ce programme séquentiel chevauche une autre planification utilisant la vanne {valve}. Les lancer ensemble peut causer des problèmes de pression d'eau.", de: "Achtung: Dieses sequentielle Programm überschneidet sich zeitlich mit einem anderen Zeitplan, der Ventil {valve} nutzt. Gleichzeitiger Betrieb kann Wasserdruckprobleme verursachen." },
  "editor.irrigation.conflict.blocked": { it: "Salvataggio bloccato per conflitto valvole (vedi Impostazioni → Irrigazione). Risolvi la sovrapposizione o disabilita il blocco.", en: "Save blocked due to valve conflict (see Settings → Irrigation). Resolve the overlap or disable the block.", fr: "Enregistrement bloqué pour conflit de vanne (voir Paramètres → Irrigation). Résous le chevauchement ou désactive le blocage.", de: "Speichern wegen Ventilkonflikt blockiert (siehe Einstellungen → Bewässerung). Überschneidung lösen oder Blockierung deaktivieren." },
  "history.kind.system": { it: "Sistema", en: "System", fr: "Système", de: "System" },
  "history.system.restart": { it: "Integrazione riavviata", en: "Integration restarted", fr: "Intégration redémarrée", de: "Integration neu gestartet" },
  "history.system.restart_abort": { it: "Irrigazione sequenziale interrotta dal riavvio, valvole chiuse per sicurezza", en: "Sequential irrigation interrupted by restart, valves closed for safety", fr: "Irrigation séquentielle interrompue par le redémarrage, vannes fermées par sécurité", de: "Sequentielle Bewässerung durch Neustart unterbrochen, Ventile sicherheitshalber geschlossen" },
  ...
  "editor.weather_rules.title": { it: "Regole", en: "Rules", fr: "Règles", de: "Regeln" },
  "editor.weather_rules.add": { it: "Aggiungi regola", en: "Add rule", fr: "Ajouter une règle", de: "Regel hinzufügen" },
  "editor.weather_rules.empty": { it: "Nessuna regola · esecuzione fissa indipendente dal meteo", en: "No rules · fixed execution regardless of weather", fr: "Aucune règle · exécution fixe indépendamment de la météo", de: "Keine Regeln · feste Ausführung unabhängig vom Wetter" },
  ...
  "editor.scene.on_demand.label": { it: "Applica su richiesta", en: "Apply on demand", fr: "Appliquer à la demande", de: "Bei Bedarf anwenden" },
  "editor.scene.on_demand.hint": { it: "Non attiva la scena a inizio fascia (accenderebbe le luci). La applica solo quando un dispositivo della scena viene acceso durante la fascia, o subito se è già acceso.", en: "Doesn't activate the scene at block start (it would switch the lights on). It applies the scene only when one of the scene's devices is turned on during the block, or immediately if one is already on.", fr: "N'active pas la scène au début du créneau (cela allumerait les lumières). Elle est appliquée uniquement lorsqu'un appareil de la scène est allumé pendant le créneau, ou immédiatement si l'un est déjà allumé.", de: "Aktiviert die Szene nicht zu Blockbeginn (das würde die Lichter einschalten). Sie wird nur angewendet, wenn ein Gerät der Szene während des Blocks eingeschaltet wird, oder sofort, wenn eines bereits an ist." },
  ...
  "devices.alias.hint": { it: "Soprannome usato solo dentro Chronos: clicca e rinomina, il friendly name in Home Assistant non cambia", en: "Nickname used only inside Chronos: click to rename, the Home Assistant friendly name is untouched", fr: "Surnom utilisé uniquement dans Chronos : cliquez pour renommer, le friendly name de Home Assistant ne change pas", de: "Spitzname nur innerhalb von Chronos: zum Umbenennen klicken, der Friendly Name in Home Assistant bleibt unverändert" },
  ...
  "settings.weather.subtitle": { it: "Entità HA usata per valutare le regole · puoi anche puntare attributi specifici a sensori puntuali (stazione meteo locale, Ecowitt, …)", en: "HA entity used to evaluate rules · you can also map specific attributes to point sensors (local weather station, Ecowitt, …)", fr: "Entité HA utilisée pour évaluer les règles · tu peux aussi mapper des attributs spécifiques à des capteurs ponctuels (station météo locale, Ecowitt, …)", de: "HA-Entität zur Auswertung der Regeln · einzelne Attribute können auch auf Punktsensoren gemappt werden (lokale Wetterstation, Ecowitt, …)" },
  ...
  "settings.notify.rule_triggered": { it: "Regola attivata", en: "Rule triggered", fr: "Règle déclenchée", de: "Regel ausgelöst" },
  ...
  "settings.safety.title": { it: "Sicurezza", en: "Safety", fr: "Sécurité", de: "Sicherheit" },
  "settings.safety.subtitle": { it: "Conferme richieste prima delle azioni che spengono qualcosa", en: "Confirmations asked before actions that switch something off", fr: "Confirmations demandées avant les actions qui désactivent quelque chose", de: "Rückfragen vor Aktionen, die etwas abschalten" },
  "settings.safety.confirm_disable.title": { it: "Chiedi conferma prima di disattivare", en: "Ask before disabling", fr: "Demander avant de désactiver", de: "Vor dem Deaktivieren nachfragen" },
  "settings.safety.confirm_disable.desc": { it: "Quando spegni una schedulazione o una regola dalla card, chiede conferma con un avviso. Riaccenderle non chiede mai nulla. Non vale per l'entità switch della schedulazione né per il servizio chronos.schedule_toggle, così le automazioni continuano a funzionare da sole.", en: "When you switch a schedule or a rule off from the card, a confirmation is asked first. Turning them back on never asks. It does not apply to the schedule's switch entity nor to the chronos.schedule_toggle service, so automations keep working unattended.", fr: "Quand tu désactives une planification ou une règle depuis la carte, une confirmation est demandée. Les réactiver ne demande jamais rien. Ne s'applique ni à l'entité switch de la planification ni au service chronos.schedule_toggle, pour que les automatisations continuent seules.", de: "Wenn du einen Zeitplan oder eine Regel in der Karte abschaltest, wird zuerst nachgefragt. Beim Wiedereinschalten nie. Gilt nicht für die Switch-Entität des Zeitplans und nicht für den Dienst chronos.schedule_toggle, damit Automationen unbeaufsichtigt weiterlaufen." },
  ...
  "settings.colors.kind.title": { it: "Colori timeline (azioni)", en: "Timeline colors (actions)", fr: "Couleurs de la timeline (actions)", de: "Timeline-Farben (Aktionen)" },
  "settings.colors.kind.desc": { it: "Colore dei blocchi nella timeline in base al tipo di azione (on/off/set/preset/cmd)", en: "Color of timeline blocks by action kind (on/off/set/preset/cmd)", fr: "Couleur des blocs de la timeline par type d'action (on/off/set/preset/cmd)", de: "Farbe der Timeline-Blöcke nach Aktionsart (on/off/set/preset/cmd)" },
  "settings.colors.simple.title": { it: "Dispositivi a stato semplice", en: "Simple-state devices", fr: "Appareils à état simple", de: "Geräte mit einfachem Zustand" },
  "settings.colors.simple.desc": { it: "Colore quando il dispositivo è attivo o inattivo, per tipi senza range continuo", en: "Color when the device is active or inactive, for types without a continuous range", fr: "Couleur lorsque l'appareil est actif ou inactif, pour les types sans plage continue", de: "Farbe wenn das Gerät aktiv oder inaktiv ist, für Typen ohne Bereich" },
  "settings.colors.range.title": { it: "Dispositivi con range", en: "Range devices", fr: "Appareils à plage", de: "Geräte mit Bereich" },
  "settings.colors.range.desc": { it: "Colore in base al valore (gradiente) per tapparelle (posizione) e ventilatori (velocità)", en: "Color by value (gradient) for blinds (position) and fans (speed)", fr: "Couleur selon la valeur (gradient) pour volets (position) et ventilateurs (vitesse)", de: "Farbe je Wert (Verlauf) für Rollläden (Position) und Ventilatoren (Geschwindigkeit)" },
  "settings.colors.active": { it: "Attivo", en: "Active", fr: "Actif", de: "Aktiv" },
  "settings.colors.inactive": { it: "Inattivo", en: "Inactive", fr: "Inactif", de: "Inaktiv" },
  "settings.colors.start": { it: "Inizio", en: "Start", fr: "Début", de: "Start" },
  "settings.colors.end": { it: "Fine", en: "End", fr: "Fin", de: "Ende" },
  "settings.colors.reset_all.title": { it: "Reset tutti i colori", en: "Reset all colors", fr: "Réinitialiser toutes les couleurs", de: "Alle Farben zurücksetzen" },
  "settings.colors.reset_all.desc": { it: "Ripristina i valori di default per tutte le sezioni colore (azioni, dispositivi, gradienti, preset, stops temperatura, light).", en: "Restore default values for every color section (actions, devices, gradients, presets, temperature stops, light).", fr: "Restaure les valeurs par défaut pour toutes les sections de couleur.", de: "Standardwerte für alle Farbabschnitte wiederherstellen." },
  "settings.colors.reset_all.button": { it: "Reset", en: "Reset", fr: "Réinitialiser", de: "Zurücksetzen" },
  "settings.colors.reset_all.confirm": { it: "Vuoi ripristinare tutti i colori ai valori di default? Questa azione sovrascrive ogni personalizzazione.", en: "Reset every color to defaults? This overwrites all your customizations.", fr: "Réinitialiser toutes les couleurs aux valeurs par défaut ? Cette action écrase toutes les personnalisations.", de: "Alle Farben auf Standard zurücksetzen? Dies überschreibt alle Anpassungen." },
  ...
  "scard.k.weather": { it: "Regole", en: "Rules", fr: "Règles", de: "Regeln" },
  ...
  "live.map.subtitle": { it: "Radar pioggia RainViewer · sfondo {source}", en: "RainViewer rain radar · {source} base map", fr: "Radar de pluie RainViewer · fond {source}", de: "RainViewer-Regenradar · {source}-Grundkarte" },
  ...
  "live.map.owm_error": { it: "OpenWeatherMap rifiuta le tile: chiave non valida o non ancora attiva (una chiave nuova impiega qualche ora)", en: "OpenWeatherMap is rejecting the tiles: key invalid or not active yet (a new key takes a few hours)", fr: "OpenWeatherMap rejette les tuiles : clé invalide ou pas encore active (une nouvelle clé prend quelques heures)", de: "OpenWeatherMap lehnt die Kacheln ab: Schlüssel ungültig oder noch nicht aktiv (ein neuer Schlüssel braucht einige Stunden)" },
  ...
  "settings.nav.title": { it: "Navigazione", en: "Navigation", fr: "Navigation", de: "Navigation" },
  "settings.nav.top": { it: "Barra in alto", en: "Top bar", fr: "Barre en haut", de: "Obere Leiste" },
  "settings.nav.sidebar": { it: "Barra laterale (classica)", en: "Sidebar (classic)", fr: "Barre latérale (classique)", de: "Seitenleiste (klassisch)" },
  "nav.menu": { it: "Menu", en: "Menu", fr: "Menu", de: "Menü" },
  "settings.nav.sidebar_panel.title": { it: "Voce nella barra laterale di Home Assistant", en: "Entry in the Home Assistant sidebar", fr: "Entrée dans la barre latérale de Home Assistant", de: "Eintrag in der Home-Assistant-Seitenleiste" },
  "settings.nav.sidebar_panel.desc": { it: "Apre Chronos a schermo intero dalla barra laterale, senza passare da una plancia. Le card nelle plance restano disponibili in ogni caso.", en: "Opens Chronos full screen from the sidebar, without going through a dashboard. The dashboard cards stay available either way.", fr: "Ouvre Chronos en plein écran depuis la barre latérale, sans passer par un tableau de bord. Les cartes des tableaux de bord restent disponibles dans tous les cas.", de: "Öffnet Chronos im Vollbild aus der Seitenleiste, ohne den Umweg über ein Dashboard. Die Dashboard-Karten bleiben in jedem Fall verfügbar." },
  "pause.button": { it: "Pausa", en: "Pause", fr: "Pause", de: "Pause" },
  "pause.resume": { it: "Riprendi", en: "Resume", fr: "Reprendre", de: "Fortsetzen" },
  "pause.close": { it: "Chiudi", en: "Close", fr: "Fermer", de: "Schließen" },
  "pause.title": { it: "Metti in pausa {name}", en: "Pause {name}", fr: "Mettre {name} en pause", de: "{name} pausieren" },
  "pause.desc": { it: "Fino ad allora Chronos lascia stare i dispositivi di questa schedulazione. Quello che ha acceso lui viene spento subito, così niente resta in funzione perché il suo spegnimento è finito in pausa.", en: "Until then Chronos leaves this schedule's devices alone. What it switched on itself is switched off first, so nothing keeps running because its switch-off got paused away.", fr: "D'ici là, Chronos ne touche plus aux appareils de cette planification. Ce qu'il avait allumé lui-même est éteint d'abord, pour que rien ne reste en marche parce que son extinction a été mise en pause.", de: "Bis dahin lässt Chronos die Geräte dieses Zeitplans in Ruhe. Was er selbst eingeschaltet hat, wird zuerst ausgeschaltet, damit nichts weiterläuft, weil sein Ausschalten pausiert wurde." },
  "pause.skip_today": { it: "Salta oggi", en: "Skip today", fr: "Sauter aujourd'hui", de: "Heute überspringen" },
  "pause.skip_today.hint": { it: "fino a mezzanotte", en: "until midnight", fr: "jusqu'à minuit", de: "bis Mitternacht" },
  "pause.hours": { it: "Per {n} ore", en: "For {n} hours", fr: "Pendant {n} heures", de: "Für {n} Stunden" },
  "pause.custom": { it: "Fino a data e ora", en: "Until a date and time", fr: "Jusqu'à une date et une heure", de: "Bis Datum und Uhrzeit" },
  "pause.apply": { it: "Metti in pausa", en: "Pause", fr: "Mettre en pause", de: "Pausieren" },
  "pause.badge": { it: "In pausa fino a {when}", en: "Paused until {when}", fr: "En pause jusqu'à {when}", de: "Pausiert bis {when}" },
  "editor.conflict.title": { it: "Dispositivi condivisi con altre schedulazioni", en: "Devices shared with other schedules", fr: "Appareils partagés avec d'autres planifications", de: "Geräte, die andere Zeitpläne mitbenutzen" },
  "editor.conflict.item": { it: "{device}: anche «{name}» agisce {b}, sovrapposto a {a}. Vince l'ultimo comando inviato, e da fuori sembra che il dispositivo faccia da solo.", en: "{device}: “{name}” also acts {b}, overlapping {a}. The last command sent wins, which from outside looks like the device acting on its own.", fr: "{device} : « {name} » agit aussi {b}, en chevauchement avec {a}. La dernière commande envoyée l'emporte, et de l'extérieur l'appareil semble agir tout seul.", de: "{device}: auch „{name}“ greift {b} ein, überlappend mit {a}. Der zuletzt gesendete Befehl gewinnt, und von außen sieht es aus, als handle das Gerät von allein." },
  "overview.conflicts": { it: "Conflitti: {n}", en: "Conflicts: {n}", fr: "Conflits : {n}", de: "Konflikte: {n}" },
  "mode.home": { it: "Casa", en: "Home", fr: "Maison", de: "Zuhause" },
  "mode.away": { it: "Fuori", en: "Away", fr: "Absent", de: "Abwesend" },
  "mode.holiday": { it: "Vacanza", en: "Holiday", fr: "Vacances", de: "Urlaub" },
  "mode.hint": { it: "Modalità corrente. Le schedulazioni possono limitarsi a certe modalità: cambiarla chiude quello che Chronos aveva acceso nelle schedulazioni che escono di scena e applica subito quelle che entrano.", en: "Current mode. Schedules can restrict themselves to some modes: switching closes what Chronos had switched on in the schedules that step aside and applies the entering ones at once.", fr: "Mode actuel. Les planifications peuvent se limiter à certains modes : changer de mode éteint ce que Chronos avait allumé dans celles qui se retirent et applique aussitôt celles qui entrent.", de: "Aktueller Modus. Zeitpläne können sich auf bestimmte Modi beschränken: ein Wechsel schaltet aus, was Chronos in den ausscheidenden Zeitplänen eingeschaltet hatte, und wendet die neuen sofort an." },
  "mode.inactive": { it: "Ferma in {mode}", en: "Idle in {mode}", fr: "Inactive en {mode}", de: "Ruht in {mode}" },
  "editor.modes.label": { it: "Attiva nelle modalità", en: "Runs in modes", fr: "Active dans les modes", de: "Aktiv in den Modi" },
  "editor.modes.hint": { it: "Tutte selezionate = sempre. Deseleziona le modalità in cui questa schedulazione deve stare ferma; la modalità si cambia dalla Panoramica, dall'entità select o dal servizio chronos.set_mode.", en: "All selected = always. Deselect the modes in which this schedule must stay idle; the mode is switched from the Overview, the select entity or the chronos.set_mode service.", fr: "Tous sélectionnés = toujours. Désélectionnez les modes dans lesquels cette planification doit rester inactive ; le mode se change depuis la vue d'ensemble, l'entité select ou le service chronos.set_mode.", de: "Alle ausgewählt = immer. Wähle die Modi ab, in denen dieser Zeitplan ruhen soll; der Modus wird in der Übersicht, über die Select-Entität oder den Dienst chronos.set_mode umgeschaltet." },
  "editor.presence.away_hint": { it: "Simula presenza solo quando non c'è nessuno?", en: "Simulate presence only when nobody is home?", fr: "Simuler une présence seulement quand personne n'est là ?", de: "Anwesenheit nur simulieren, wenn niemand zu Hause ist?" },
  "editor.presence.away_button": { it: "Solo in modalità Fuori", en: "Only in Away mode", fr: "Seulement en mode Absent", de: "Nur im Modus Abwesend" },
  "settings.live.source.title": { it: "Sorgente della mappa", en: "Map source", fr: "Source de la carte", de: "Kartenquelle" },
  "settings.live.source.desc": { it: "Da dove arrivano le tile di sfondo. Esri non richiede chiavi e ha una variante scura; CARTO da settembre 2026 stampa una filigrana su ogni tile senza chiave; OpenTopoMap mostra i rilievi. Se una sorgente non risponde, la mappa passa da sola a Esri.", en: "Where the background tiles come from. Esri needs no key and has a dark variant; since September 2026 CARTO stamps a watermark on every keyless tile; OpenTopoMap shows terrain. If a source does not answer, the map falls back to Esri on its own.", fr: "D'où viennent les tuiles de fond. Esri ne demande aucune clé et a une variante sombre ; depuis septembre 2026 CARTO appose un filigrane sur chaque tuile sans clé ; OpenTopoMap montre le relief. Si une source ne répond pas, la carte repasse d'elle-même sur Esri.", de: "Woher die Hintergrundkacheln kommen. Esri braucht keinen Schlüssel und hat eine dunkle Variante; CARTO stempelt seit September 2026 ein Wasserzeichen auf jede Kachel ohne Schlüssel; OpenTopoMap zeigt das Gelände. Antwortet eine Quelle nicht, wechselt die Karte von selbst zu Esri." },
  "settings.live.source.esri": { it: "Esri, canvas grigio (senza chiave)", en: "Esri, gray canvas (no key)", fr: "Esri, fond gris (sans clé)", de: "Esri, graue Karte (ohne Schlüssel)" },
  "settings.live.source.carto": { it: "CARTO (filigrana senza chiave)", en: "CARTO (watermark without a key)", fr: "CARTO (filigrane sans clé)", de: "CARTO (Wasserzeichen ohne Schlüssel)" },
  "settings.live.source.topo": { it: "OpenTopoMap (rilievi)", en: "OpenTopoMap (terrain)", fr: "OpenTopoMap (relief)", de: "OpenTopoMap (Gelände)" },
  "settings.live.source.custom": { it: "Modello XYZ personalizzato", en: "Custom XYZ template", fr: "Modèle XYZ personnalisé", de: "Eigene XYZ-Vorlage" },
  "settings.live.source.custom_hint": { it: "Indirizzo https con {z}/{x}/{y}: un tile server tuo, oppure un provider di cui hai la chiave (MapTiler, Stadia, Thunderforest) con la chiave nell'indirizzo. In modalità scura le tile vengono scurite via filtro.", en: "An https address with {z}/{x}/{y}: your own tile server, or a provider you hold a key for (MapTiler, Stadia, Thunderforest) with the key in the address. In dark mode the tiles are darkened with a filter.", fr: "Une adresse https avec {z}/{x}/{y} : votre propre serveur de tuiles, ou un fournisseur dont vous avez la clé (MapTiler, Stadia, Thunderforest) avec la clé dans l'adresse. En mode sombre les tuiles sont assombries par un filtre.", de: "Eine https-Adresse mit {z}/{x}/{y}: ein eigener Kachelserver oder ein Anbieter, für den du einen Schlüssel hast (MapTiler, Stadia, Thunderforest), mit dem Schlüssel in der Adresse. Im dunklen Modus werden die Kacheln per Filter abgedunkelt." },
  "live.map.base_fallback": { it: "Sorgente «{source}» non raggiungibile: la mappa usa Esri", en: "Source “{source}” unreachable: the map is using Esri", fr: "Source « {source} » injoignable : la carte utilise Esri", de: "Quelle „{source}“ nicht erreichbar: die Karte nutzt Esri" },
  "editor.group.label": { it: "Gruppo", en: "Group", fr: "Groupe", de: "Gruppe" },
  "editor.group.placeholder": { it: "nessun gruppo", en: "no group", fr: "aucun groupe", de: "keine Gruppe" },
  "editor.group.hint": { it: "Le schedulazioni con lo stesso gruppo compaiono insieme in Panoramica, sotto un'intestazione richiudibile. Scrivi un nome nuovo o tocca uno di quelli già in uso.", en: "Schedules sharing a group are listed together in the overview, under a collapsible header. Type a new name or tap one already in use.", fr: "Les planifications d'un même groupe apparaissent ensemble dans la vue d'ensemble, sous un en-tête repliable. Saisissez un nouveau nom ou touchez l'un de ceux déjà utilisés.", de: "Zeitpläne mit derselben Gruppe erscheinen in der Übersicht zusammen unter einer einklappbaren Überschrift. Neuen Namen eingeben oder einen bereits verwendeten antippen." },
  "editor.group.use": { it: "Usa il gruppo {name}", en: "Use group {name}", fr: "Utiliser le groupe {name}", de: "Gruppe {name} verwenden" },
  "overview.group.ungrouped": { it: "Senza gruppo", en: "No group", fr: "Sans groupe", de: "Ohne Gruppe" },
  "overview.group.collapse": { it: "Richiudi il gruppo", en: "Collapse the group", fr: "Replier le groupe", de: "Gruppe einklappen" },
  "overview.group.expand": { it: "Espandi il gruppo", en: "Expand the group", fr: "Déplier le groupe", de: "Gruppe ausklappen" },
  "week.filter.groups": { it: "Gruppi:", en: "Groups:", fr: "Groupes :", de: "Gruppen:" },
  "settings.overview.group_by.title": { it: "Raggruppa la Panoramica per", en: "Group the overview by", fr: "Regrouper la vue d'ensemble par", de: "Übersicht gruppieren nach" },
  "settings.overview.group_by.none": { it: "Niente", en: "Nothing", fr: "Rien", de: "Nichts" },
  "settings.overview.group_by.group": { it: "Gruppo", en: "Group", fr: "Groupe", de: "Gruppe" },
  "settings.overview.group_by.type": { it: "Tipo di dispositivo", en: "Device type", fr: "Type d'appareil", de: "Gerätetyp" },
  "settings.overview.group_by.hint": { it: "Il gruppo si assegna nell'editor di ogni schedulazione. Con un solo gruppo la Panoramica resta piatta; le intestazioni si richiudono con un tocco e lo stato viene ricordato su questo dispositivo.", en: "The group is set in each schedule's editor. With a single group the overview stays flat; headers collapse with a tap and the state is remembered on this device.", fr: "Le groupe se définit dans l'éditeur de chaque planification. Avec un seul groupe, la vue d'ensemble reste plate ; les en-têtes se replient d'un toucher et l'état est mémorisé sur cet appareil.", de: "Die Gruppe wird im Editor jedes Zeitplans gesetzt. Mit nur einer Gruppe bleibt die Übersicht flach; Überschriften klappen per Tipp ein, der Zustand wird auf diesem Gerät gemerkt." },
  "editor.group.color": { it: "Colore del gruppo", en: "Group colour", fr: "Couleur du groupe", de: "Gruppenfarbe" },
  "editor.group.color.none": { it: "Nessun colore", en: "No colour", fr: "Aucune couleur", de: "Keine Farbe" },
  "editor.manual_off.label": { it: "Spegni da solo dopo un'accensione manuale", en: "Switch off after a manual turn-on", fr: "Éteindre après un allumage manuel", de: "Nach manuellem Einschalten ausschalten" },
  "editor.manual_off.hint": { it: "Se qualcuno accende a mano uno di questi dispositivi, Chronos lo spegne dopo questi minuti, a qualsiasi ora, anche fuori dalle fasce. Le accensioni fatte da Chronos non contano: per quelle valgono lo spegnimento automatico della fascia e l'azione di fine. Vuoto = disattivato.", en: "If someone switches one of these devices on by hand, Chronos switches it off after this many minutes, at any time of day, blocks or not. Turn-ons made by Chronos do not count: the block's own auto-off and end action apply to those. Empty = off.", fr: "Si quelqu'un allume à la main l'un de ces appareils, Chronos l'éteint après ce délai, à toute heure, même hors des plages. Les allumages faits par Chronos ne comptent pas : pour eux s'appliquent l'extinction automatique de la plage et l'action de fin. Vide = désactivé.", de: "Schaltet jemand eines dieser Geräte von Hand ein, schaltet Chronos es nach so vielen Minuten wieder aus, zu jeder Tageszeit, auch außerhalb der Zeitblöcke. Einschaltungen durch Chronos zählen nicht: für sie gelten die automatische Abschaltung des Blocks und die Endaktion. Leer = aus." },
  "editor.auto_off.both_hint": { it: "Sono impostati sia lo spegnimento automatico sia l'azione di fine: il primo conta dall'accensione, la seconda scatta all'ora di fine della fascia. Agisce quello che arriva prima, l'altro trova il dispositivo già spento.", en: "Both auto-off and the end action are set: the first counts from the turn-on, the second fires at the block's end. Whichever comes first acts; the other finds the device already off.", fr: "L'extinction automatique et l'action de fin sont toutes deux définies : la première compte depuis l'allumage, la seconde se déclenche à la fin de la plage. La première arrivée agit, l'autre trouve l'appareil déjà éteint.", de: "Automatische Abschaltung und Endaktion sind beide gesetzt: die erste zählt ab dem Einschalten, die zweite feuert am Blockende. Was zuerst kommt, handelt; die andere findet das Gerät bereits aus." },
  "settings.nav.hint": { it: "La barra in alto unisce menù, orologio e titolo in una sola riga di icone e libera spazio per i contenuti, soprattutto su cellulare. La voce attiva mostra la sua etichetta.", en: "The top bar merges menu, clock and title into a single icon row and frees space for content, especially on phones. The active entry shows its label.", fr: "La barre en haut fusionne menu, horloge et titre en une seule rangée d'icônes et libère de l'espace pour le contenu, surtout sur mobile. L'entrée active affiche son libellé.", de: "Die obere Leiste vereint Menü, Uhr und Titel in einer Icon-Zeile und schafft Platz für Inhalte, besonders auf dem Handy. Der aktive Eintrag zeigt seine Beschriftung." },
  "settings.live.fx.title": { it: "Sfondo meteo animato", en: "Animated weather background", fr: "Fond météo animé", de: "Animierter Wetterhintergrund" },
  "settings.live.fx.desc": { it: "Il riquadro meteo della schermata Live si anima in base alle condizioni: sole, nuvole, nebbia, pioggia, temporale con lampi, neve. Effetti leggeri solo CSS; disattivati automaticamente se il sistema chiede di ridurre il movimento.", en: "The weather hero on the Live screen animates with the conditions: sun, clouds, fog, rain, storm with lightning, snow. Lightweight CSS-only effects; automatically disabled when the system asks for reduced motion.", fr: "L'encart météo de l'écran en direct s'anime selon les conditions : soleil, nuages, brouillard, pluie, orage avec éclairs, neige. Effets légers en CSS pur ; désactivés automatiquement si le système demande de réduire les animations.", de: "Die Wetterkachel der Live-Ansicht animiert sich je nach Wetterlage: Sonne, Wolken, Nebel, Regen, Gewitter mit Blitzen, Schnee. Leichte reine CSS-Effekte; automatisch deaktiviert, wenn das System reduzierte Bewegung verlangt." },
  "settings.live.map.title": { it: "Mostra mappa meteo", en: "Show weather map", fr: "Afficher la carte météo", de: "Wetterkarte anzeigen" },
  "settings.live.map.desc": { it: "Mappa interattiva con radar pioggia nella schermata Live. Le tile di sfondo (Esri di default, altre sorgenti qui sotto) e il radar RainViewer vengono scaricati da internet alla visualizzazione: disattiva per installazioni offline.", en: "Interactive map with rain radar on the Live screen. The base map tiles (Esri by default, other sources below) and the RainViewer radar are fetched from the internet at view time: turn off for offline installations.", fr: "Carte interactive avec radar de pluie sur l'écran en direct. Les tuiles de fond (Esri par défaut, autres sources ci-dessous) et le radar RainViewer sont téléchargés à l'affichage : désactivez pour les installations hors ligne.", de: "Interaktive Karte mit Regenradar in der Live-Ansicht. Die Grundkarten-Kacheln (standardmäßig Esri, weitere Quellen darunter) und das RainViewer-Radar werden beim Anzeigen aus dem Internet geladen: für Offline-Installationen abschalten." },
  ...
  "dup.include_rules": { it: "Copia anche le {n} regole", en: "Also copy the {n} rules", fr: "Copier aussi les {n} règles", de: "Auch die {n} Regeln kopieren" },
  ...
  // Rule builder
  "wr.heading": { it: "Regola", en: "Rule", fr: "Règle", de: "Regel" },
  "wr.heading.edit": { it: "Modifica regola", en: "Edit rule", fr: "Modifier la règle", de: "Regel bearbeiten" },
  ...
  "wr.if.sensor.hint": { it: "Sensori numerici, oppure entità on/off: sensore giorno lavorativo, calendari, interruttori virtuali, pianificazioni HA, persone (home/not_home).", en: "Numeric sensors, or on/off entities: workday sensor, calendars, input booleans, HA schedule helpers, people (home/not_home).", fr: "Capteurs numériques, ou entités on/off : capteur jour ouvré, calendriers, booléens, planifications HA, personnes (home/not_home).", de: "Numerische Sensoren oder Ein/Aus-Entitäten: Arbeitstag-Sensor, Kalender, Input Booleans, HA-Zeitpläne, Personen (home/not_home)." },
  ...
  "editor.presence.label": { it: "Simula presenza in casa", en: "Simulate someone being home", fr: "Simuler une présence", de: "Anwesenheit simulieren" },
  "editor.presence.hint": { it: "Invece di tenere un solo stato per tutta la fascia, il blocco accende e spegne più volte a orari diversi ogni giorno. Tu decidi quante volte e per quanto; Chronos sceglie i minuti esatti e quale dispositivo, perché è la parte che deve sembrare non programmata.", en: "Instead of holding one state for the whole window, the block switches on and off several times, at different moments each day. You set how many times and for how long; Chronos picks the exact minutes and which device, because that is the part that has to look unplanned.", fr: "Au lieu de maintenir un seul état pendant toute la plage, le bloc s'allume et s'éteint plusieurs fois, à des moments différents chaque jour. Vous fixez combien de fois et combien de temps ; Chronos choisit les minutes exactes et l'appareil, car c'est la partie qui doit paraître imprévue.", de: "Statt einen Zustand für das ganze Fenster zu halten, schaltet der Block mehrmals ein und aus, jeden Tag zu anderen Zeiten. Du legst fest wie oft und wie lange; Chronos wählt die genauen Minuten und das Gerät, denn das ist der Teil, der ungeplant wirken muss." },
  "editor.presence.cycles": { it: "Accensioni al massimo", en: "Activations at most", fr: "Activations au maximum", de: "Aktivierungen höchstens" },
  "editor.presence.min": { it: "Durata minima", en: "Shortest", fr: "Durée minimale", de: "Kürzeste Dauer" },
  "editor.presence.max": { it: "Durata massima", en: "Longest", fr: "Durée maximale", de: "Längste Dauer" },
  "editor.presence.devices_hint": { it: "Ogni accensione sceglie a caso uno dei dispositivi del blocco, così non si illumina sempre la stessa stanza. Il piano è deciso una volta al giorno e non cambia più fino a mezzanotte, quindi un riavvio riprende la serata dov'era.", en: "Each activation picks one of the block's devices at random, so it is not always the same room lighting up. The plan is drawn once a day and does not change until midnight, so a restart picks the evening back up where it was.", fr: "Chaque activation choisit au hasard l'un des appareils du bloc, pour que ce ne soit pas toujours la même pièce qui s'allume. Le plan est tiré une fois par jour et ne change plus jusqu'à minuit : un redémarrage reprend la soirée où elle en était.", de: "Jede Aktivierung wählt zufällig eines der Geräte des Blocks, damit nicht immer derselbe Raum leuchtet. Der Plan wird einmal täglich gezogen und ändert sich bis Mitternacht nicht mehr, ein Neustart setzt den Abend also dort fort, wo er war." },
  "editor.trigger.label": { it: "Agisci anche alla fine del blocco", en: "Act at the end of the block too", fr: "Agir aussi à la fin du bloc", de: "Auch am Blockende handeln" },
  "editor.trigger.hint": { it: "Di norma il blocco invia il suo comando solo quando inizia. Attivando questa opzione, quando il blocco finisce (e non ne parte subito un altro) viene inviata anche l'azione scelta qui sotto: di solito lo spegnimento, ma puoi scegliere qualsiasi stato.", en: "By default a block only sends its command when it starts. With this on, when the block ends (and no other block takes over) it also sends the action chosen below: usually an off, but any state works.", fr: "Par défaut, un bloc n'envoie sa commande qu'à son début. Avec cette option, quand le bloc se termine (et qu'aucun autre ne prend le relais), l'action choisie ci-dessous est envoyée : en général une extinction, mais n'importe quel état convient.", de: "Normalerweise sendet ein Block seinen Befehl nur beim Start. Mit dieser Option wird am Blockende (wenn kein anderer Block übernimmt) zusätzlich die unten gewählte Aktion gesendet: meist ein Ausschalten, aber jeder Zustand ist möglich." },
  "editor.jitter.label": { it: "Scostamento casuale", en: "Random shift", fr: "Décalage aléatoire", de: "Zufällige Verschiebung" },
  "editor.jitter.hint": { it: "Il blocco si sposta ogni giorno di una quantità casuale entro questi minuti, in avanti o indietro, mantenendo la stessa durata. L'orario resta poi identico per tutta la giornata. Utile per simulare la presenza in casa.", en: "The block moves every day by a random amount within these minutes, earlier or later, keeping the same length. The time then stays identical for the whole day. Useful to simulate someone being home.", fr: "Le bloc se décale chaque jour d'une quantité aléatoire dans cette limite, en avance ou en retard, en gardant la même durée. L'horaire reste ensuite identique toute la journée. Utile pour simuler une présence.", de: "Der Block verschiebt sich täglich zufällig um bis zu so viele Minuten, früher oder später, bei gleicher Länge. Die Uhrzeit bleibt dann den ganzen Tag gleich. Nützlich, um Anwesenheit zu simulieren." },
  "settings.price.entity": { it: "Entità prezzi elettricità", en: "Electricity price entity", fr: "Entité des prix de l'électricité", de: "Strompreis-Entität" },
  "settings.price.entity.hint": { it: "Sensore di una integrazione prezzi già installata (Nordpool, ENTSO-e, Tibber…). Serve solo per le variabili price.* nelle regole: prezzo attuale, posizione dell'ora nella classifica del giorno e scarto dalla media. Vuoto = regole sui prezzi disattivate.", en: "Sensor from a price integration you already have (Nordpool, ENTSO-e, Tibber…). Used only for the price.* rule variables: current price, the hour's rank in the day and the gap from the average. Empty = price rules disabled.", fr: "Capteur d'une intégration de prix déjà installée (Nordpool, ENTSO-e, Tibber…). Sert uniquement aux variables price.* des règles : prix actuel, rang de l'heure dans la journée et écart à la moyenne. Vide = règles de prix désactivées.", de: "Sensor einer bereits installierten Preis-Integration (Nordpool, ENTSO-e, Tibber…). Wird nur für die price.*-Regelvariablen genutzt: aktueller Preis, Rang der Stunde im Tag und Abstand zum Mittel. Leer = Preisregeln deaktiviert." },
  "settings.blocks.title": { it: "Blocchi orari", en: "Time blocks", fr: "Blocs horaires", de: "Zeitblöcke" },
  "settings.blocks.subtitle": { it: "Comportamento predefinito dei nuovi blocchi", en: "Default behaviour of new blocks", fr: "Comportement par défaut des nouveaux blocs", de: "Standardverhalten neuer Blöcke" },
  "settings.blocks.trigger": { it: "Quando agisce un blocco appena creato", en: "When a newly created block acts", fr: "Quand agit un bloc nouvellement créé", de: "Wann ein neu erstellter Block handelt" },
  "settings.blocks.trigger.start": { it: "Solo all'inizio", en: "At the start only", fr: "Au début seulement", de: "Nur am Anfang" },
  "settings.blocks.trigger.both": { it: "Inizio e fine", en: "Start and end", fr: "Début et fin", de: "Anfang und Ende" },
  "settings.blocks.trigger.hint": { it: "Vale solo per i blocchi creati d'ora in poi: quelli esistenti non cambiano comportamento, e in ogni blocco puoi comunque decidere caso per caso.", en: "Applies only to blocks created from now on: existing blocks keep behaving exactly as they do, and every block can still be set individually.", fr: "Ne s'applique qu'aux blocs créés à partir de maintenant : les blocs existants gardent leur comportement, et chaque bloc reste réglable individuellement.", de: "Gilt nur für ab jetzt erstellte Blöcke: bestehende Blöcke verhalten sich unverändert, und jeder Block bleibt einzeln einstellbar." },
  "tl.jitter.zone": { it: "Il blocco può spostarsi di ±{min} min: ogni giorno parte da un punto diverso di questa fascia", en: "The block can shift by ±{min} min: each day it starts somewhere in this band", fr: "Le bloc peut se décaler de ±{min} min : chaque jour il démarre quelque part dans cette plage", de: "Der Block kann sich um ±{min} min verschieben: jeden Tag startet er irgendwo in diesem Bereich" },
  "tl.run.extended": { it: "Con la regola al massimo arriva fino alle {until}", en: "With the rule at its maximum it runs until {until}", fr: "Avec la règle au maximum, il va jusqu'à {until}", de: "Mit der Regel am Maximum läuft es bis {until}" },
  "editor.irrigation.overlap.title": { it: "Programmi di irrigazione che possono accavallarsi", en: "Irrigation programs that can overlap", fr: "Programmes d'arrosage qui peuvent se chevaucher", de: "Bewässerungsprogramme, die sich überschneiden können" },
  "editor.irrigation.overlap.item": { it: "{a} si accavalla con {name} ({b}){note}", en: "{a} overlaps {name} ({b}){note}", fr: "{a} chevauche {name} ({b}){note}", de: "{a} überschneidet sich mit {name} ({b}){note}" },
  "editor.irrigation.overlap.when_scaled": { it: " · con la regola di scala al massimo", en: " · with the scale rule at its maximum", fr: " · avec la règle d'échelle au maximum", de: " · mit der Skalierungsregel am Maximum" },
  "tl.ref.clash": { it: "Si sovrappone a questa schedulazione", en: "Overlaps this schedule", fr: "Chevauche cette planification", de: "Überschneidet sich mit diesem Zeitplan" },
  "editor.compare.none": { it: "Nessun confronto", en: "No comparison", fr: "Aucune comparaison", de: "Kein Vergleich" },
  "editor.compare.with": { it: "Confronta con: {name}", en: "Compare with: {name}", fr: "Comparer avec : {name}", de: "Vergleichen mit: {name}" },
  "editor.compare.hint": { it: "Mostra un'altra schedulazione sotto la barra (dentro al cerchio nella vista radiale) per confrontarle. Le sovrapposizioni sono bordate di rosso.", en: "Shows another schedule under the bar (inside the circle on the radial view) to compare them. Overlapping stretches are outlined in red.", fr: "Affiche une autre planification sous la barre (dans le cercle en vue radiale) pour les comparer. Les chevauchements sont entourés de rouge.", de: "Zeigt einen anderen Zeitplan unter dem Balken (in der Radialansicht im Kreis) zum Vergleich. Überschneidungen sind rot umrandet." },
  "scard.open_chronos": { it: "Apri in Chronos", en: "Open in Chronos", fr: "Ouvrir dans Chronos", de: "In Chronos öffnen" },
  "tl.ruled": { it: "Una regola agisce su questo blocco", en: "A rule acts on this block", fr: "Une règle agit sur ce bloc", de: "Eine Regel wirkt auf diesen Block" },
  "wr.effect.hold": { it: "Mantieni su soglia", en: "Hold on threshold", fr: "Maintenir au seuil", de: "Auf Schwelle halten" },
  "wr.effect.hold.desc": { it: "Accende e spegne da solo in base a un valore misurato (es. luci con i lux)", en: "Switches on and off by itself following a measured value (e.g. lights by lux)", fr: "Allume et éteint tout seul selon une valeur mesurée (ex. lumières selon les lux)", de: "Schaltet selbstständig nach einem Messwert ein und aus (z. B. Licht nach Lux)" },
  "wr.hold.var": { it: "Valore da seguire", en: "Value to follow", fr: "Valeur à suivre", de: "Zu verfolgender Wert" },
  "wr.hold.var.weather": { it: "Attributi meteo", en: "Weather attributes", fr: "Attributs météo", de: "Wetterattribute" },
  "wr.hold.var.sensors": { it: "Sensori Home Assistant", en: "Home Assistant sensors", fr: "Capteurs Home Assistant", de: "Home-Assistant-Sensoren" },
  "wr.hold.var.hint": { it: "I lux esterni non sono esposti dalle integrazioni meteo: mappa il tuo sensore in Impostazioni → Meteo, oppure scegli qui direttamente il sensore.", en: "Outdoor lux is not exposed by weather integrations: map your own sensor under Settings → Weather, or pick the sensor directly here.", fr: "Les lux extérieurs ne sont pas fournis par les intégrations météo : associez votre capteur dans Réglages → Météo, ou choisissez-le directement ici.", de: "Außen-Lux liefern Wetterintegrationen nicht: eigenen Sensor unter Einstellungen → Wetter zuordnen oder hier direkt auswählen." },
  "wr.hold.on": { it: "Soglia di attivazione", en: "Engage threshold", fr: "Seuil d'activation", de: "Einschaltschwelle" },
  "wr.hold.off": { it: "Soglia di rilascio", en: "Release threshold", fr: "Seuil de relâche", de: "Ausschaltschwelle" },
  "wr.hold.action": { it: "Azione all'attivazione", en: "Action when engaged", fr: "Action à l'activation", de: "Aktion beim Einschalten" },
  "wr.hold.release_action": { it: "Azione al rilascio", en: "Action on release", fr: "Action à la relâche", de: "Aktion beim Ausschalten" },
  "wr.hold.dwell": { it: "Ritardo di conferma", en: "Confirmation delay", fr: "Délai de confirmation", de: "Bestätigungsverzögerung" },
  "wr.hold.dwell.hint": { it: "Il nuovo stato deve durare questi minuti prima di agire, così una nuvola di passaggio non fa lampeggiare la luce. 0 = agisci subito.", en: "The new state must last this many minutes before acting, so a passing cloud can't make the light flicker. 0 = act at once.", fr: "Le nouvel état doit durer ce nombre de minutes avant d'agir, pour qu'un nuage de passage ne fasse pas clignoter la lumière. 0 = agir tout de suite.", de: "Der neue Zustand muss so viele Minuten anhalten, bevor gehandelt wird, damit eine vorbeiziehende Wolke das Licht nicht flackern lässt. 0 = sofort handeln." },
  "wr.hold.preview": { it: "Cosa farà", en: "What it will do", fr: "Ce qu'elle fera", de: "Was sie tun wird" },
  "wr.hold.preview.below": { it: "Sotto {on} → {a} · sopra {off} → {b}", en: "Below {on} → {a} · above {off} → {b}", fr: "Sous {on} → {a} · au-dessus de {off} → {b}", de: "Unter {on} → {a} · über {off} → {b}" },
  "wr.hold.preview.above": { it: "Sopra {on} → {a} · sotto {off} → {b}", en: "Above {on} → {a} · below {off} → {b}", fr: "Au-dessus de {on} → {a} · sous {off} → {b}", de: "Über {on} → {a} · unter {off} → {b}" },
  ...
  "wr.scale.out_min": { it: "Output quando la variabile è al MIN", en: "Output at variable MIN", fr: "Sortie quand la variable est au MIN", de: "Ausgabe bei Variable MIN" },
  "wr.scale.out_max": { it: "Output quando la variabile è al MAX", en: "Output at variable MAX", fr: "Sortie quand la variable est au MAX", de: "Ausgabe bei Variable MAX" },
  "wr.scale.map_hint": { it: "La mappatura è lineare tra i due estremi: per una relazione inversa (più pioggia = meno acqua) scrivi un Output al MIN più grande di quello al MAX.", en: "The mapping is linear between the two ends: for an inverse relation (more rain = less water) set the output at MIN higher than the one at MAX.", fr: "La correspondance est linéaire entre les deux extrêmes : pour une relation inverse (plus de pluie = moins d'eau), mettez la sortie au MIN plus grande que celle au MAX.", de: "Die Zuordnung ist linear zwischen beiden Enden: für eine umgekehrte Beziehung (mehr Regen = weniger Wasser) die Ausgabe bei MIN größer setzen als die bei MAX." },
  "wr.warn.duration_on_irrigation": { it: "Su un programma di irrigazione questo effetto cambia la fascia oraria del blocco, NON i minuti d'acqua. Per allungare o accorciare l'irrigazione usa \"Scala valore\".", en: "On an irrigation program this effect changes the block's time window, NOT the watering minutes. To make watering longer or shorter use \"Scale value\".", fr: "Sur un programme d'irrigation, cet effet change la plage horaire du bloc, PAS les minutes d'arrosage. Pour allonger ou raccourcir l'arrosage, utilisez « Mettre à l'échelle la valeur ».", de: "Bei einem Bewässerungsprogramm ändert dieser Effekt das Zeitfenster des Blocks, NICHT die Bewässerungsminuten. Zum Verlängern oder Verkürzen \"Wert skalieren\" verwenden." },
  ...
  "help.quickstart.s4.title": { it: "Aggiungi regole (opzionale)", en: "Add rules (optional)", fr: "Ajoute des règles (optionnel)", de: "Regeln hinzufügen (optional)" },
  ...
  "help.faq.q3": { it: "La regola non scatta anche se la condizione è vera.", en: "A rule isn't triggering even when the condition is true.", fr: "Une règle ne se déclenche pas malgré la condition vraie.", de: "Eine Regel löst nicht aus, obwohl die Bedingung erfüllt ist." },
  ...
  "recipe.thermostat_day_night.howto": {
    it: "Tre fasce: 00-07 e 22-24 → 18°C (eco notturno), 07-22 → 21°C (comfort). Regola: se la temperatura esterna supera 22°C la fascia viene saltata (non scalda inutilmente nelle giornate calde).",
    en: "Three blocks: 00-07 and 22-24 → 18°C (night eco), 07-22 → 21°C (comfort). Rule: if outdoor temperature exceeds 22°C the block is skipped (no needless heating on warm days).",
    fr: "Trois créneaux : 00-07 et 22-24 → 18°C (éco nuit), 07-22 → 21°C (confort). Règle : si la température extérieure dépasse 22°C le créneau est ignoré.",
    de: "Drei Blöcke: 00-07 und 22-24 → 18°C (Nacht-Eco), 07-22 → 21°C (Komfort). Regel: bei Außentemperatur über 22°C wird der Block übersprungen.",
  },
  ...
  "recipe.blinds_wind_safety.howto": {
    it: "Una fascia da alba a tramonto, posizione 100% (aperta). Regola trigger: se vento > 30 km/h forza la chiusura, una sola volta tra alba e tramonto. Senza il rate-limit le tapparelle sbatterebbero ad ogni raffica.",
    en: "One block from sunrise to sunset, position 100% (open). Trigger rule: if wind > 30 km/h force close, at most once between sunrise and sunset. Without rate-limiting the blinds would flap on every gust.",
  ...
  "recipe.irrigation_skip_rain.howto": {
    it: "Una fascia 06:00 → 06:30 con turn_on durata 30 minuti. Regola: se la pioggia prevista nelle prossime 6 ore supera 2 mm la fascia viene saltata. Risparmia acqua nei giorni di pioggia.",
    en: "One block 06:00 → 06:30 with turn_on duration 30 min. Rule: if forecast rain in the next 6 hours exceeds 2 mm the block is skipped. Saves water on rainy days.",
    fr: "Un créneau 06h00 → 06h30, turn_on durée 30 min. Règle : si la pluie prévue dans les 6 prochaines heures dépasse 2 mm, le créneau est ignoré. Économise l'eau les jours de pluie.",
    de: "Ein Block 06:00 → 06:30, turn_on Dauer 30 Min. Regel: bei Regenvorhersage > 2 mm in den nächsten 6 Std. wird der Block übersprungen. Spart Wasser an Regentagen.",
  },
  ...
  "recipe.boiler_eco_night.howto": {
    it: "Tre fasce: 00-06 ECO, 06-23 electric, 23-24 ECO. Riduce i consumi nelle ore di non utilizzo. Aggiungi una regola per saltare la fascia electric se la temperatura esterna è già alta.",
    en: "Three blocks: 00-06 ECO, 06-23 electric, 23-24 ECO. Reduces consumption during unused hours. Add a rule to skip the electric block when outside temperature is already high.",
    fr: "Trois créneaux : 00-06 ECO, 06-23 electric, 23-24 ECO. Réduit la consommation aux heures non utilisées. Ajoute une règle pour ignorer le créneau electric si la température extérieure est élevée.",
    de: "Drei Blöcke: 00-06 ECO, 06-23 electric, 23-24 ECO. Reduziert Verbrauch in ungenutzten Zeiten. Füge eine Regel hinzu, um den electric-Block bei hoher Außentemperatur zu überspringen.",
  },
  ...
  "recipe.boiler_offgrid_soc.howto": {
    it: "Dopo averla creata, apri la regola e sostituisci sensor.battery_soc con il sensor del SOC della tua batteria. Il resto della condizione (sun.minutes_until_sunset > 120) funziona ovunque tu sia.",
    en: "After creating it, open the rule and replace sensor.battery_soc with your actual battery SOC sensor. The rest of the expression (sun.minutes_until_sunset > 120) works as-is anywhere.",
    fr: "Après création, ouvre la règle et remplace sensor.battery_soc par ton capteur SOC réel. Le reste (sun.minutes_until_sunset > 120) fonctionne tel quel partout.",
    de: "Nach Anlage öffne die Regel und ersetze sensor.battery_soc durch deinen echten Batterie-SOC-Sensor. Der Rest (sun.minutes_until_sunset > 120) funktioniert überall unverändert.",
  },
  ...
  "recipe.cheap_hours_water_heater.title": { it: "Scaldacqua nelle ore più economiche", en: "Water heater in the cheapest hours", fr: "Chauffe-eau aux heures les moins chères", de: "Warmwasser in den günstigsten Stunden" },
  "recipe.cheap_hours_water_heater.when": { it: "Con una integrazione dei prezzi elettrici", en: "With an electricity price integration", fr: "Avec une intégration des prix de l'électricité", de: "Mit einer Strompreis-Integration" },
  "recipe.cheap_hours_water_heater.howto": { it: "Imposta l'entità prezzi in Impostazioni → Meteo, poi la regola scalda a 60° nelle 4 ore più economiche della giornata (price.rank_today ≤ 4). Cambia il 4 per usarne di più o di meno.", en: "Set the price entity under Settings → Weather, then the rule heats to 60° during the four cheapest hours of the day (price.rank_today ≤ 4). Change the 4 to use more or fewer hours.", fr: "Définissez l'entité des prix dans Réglages → Météo ; la règle chauffe à 60° pendant les quatre heures les moins chères (price.rank_today ≤ 4). Modifiez le 4 pour plus ou moins d'heures.", de: "Preis-Entität unter Einstellungen → Wetter setzen; die Regel heizt in den vier günstigsten Stunden auf 60° (price.rank_today ≤ 4). Die 4 anpassen für mehr oder weniger Stunden." },
  "recipe.cheap_hours_water_heater.preset_name": { it: "Scaldacqua ore economiche", en: "Water heater cheap hours", fr: "Chauffe-eau heures creuses", de: "Warmwasser günstige Stunden" },
  "recipe.presence_simulation.title": { it: "Simulazione di presenza serale", en: "Evening presence simulation", fr: "Simulation de présence le soir", de: "Anwesenheitssimulation am Abend" },
  "recipe.presence_simulation.when": { it: "Quando non sei in casa", en: "When you are away", fr: "Quand vous êtes absent", de: "Wenn du nicht zu Hause bist" },
  "recipe.presence_simulation.howto": { it: "Seleziona due o tre luci di stanze diverse. Fra le 18:30 e le 23:30 Chronos fa al massimo 4 accensioni da 20 a 90 minuti, a orari diversi ogni sera e su una luce scelta a caso. Cambia la fascia trascinando il blocco.", en: "Pick two or three lights in different rooms. Between 18:30 and 23:30 Chronos runs at most 4 activations of 20 to 90 minutes, at different times each evening and on a light chosen at random. Drag the block to change the window.", fr: "Choisissez deux ou trois lampes dans des pièces différentes. Entre 18h30 et 23h30, Chronos effectue au plus 4 activations de 20 à 90 minutes, à des heures différentes chaque soir et sur une lampe choisie au hasard. Faites glisser le bloc pour changer la plage.", de: "Wähle zwei oder drei Lampen in verschiedenen Räumen. Zwischen 18:30 und 23:30 führt Chronos höchstens 4 Aktivierungen von 20 bis 90 Minuten aus, jeden Abend zu anderen Zeiten und auf einer zufällig gewählten Lampe. Zum Ändern des Fensters den Block ziehen." },
  "recipe.presence_simulation.preset_name": { it: "Presenza simulata", en: "Simulated presence", fr: "Présence simulée", de: "Simulierte Anwesenheit" },
  "recipe.workdays_only_morning.title": { it: "Routine del mattino solo nei giorni lavorativi", en: "Morning routine on workdays only", fr: "Routine du matin les jours ouvrés seulement", de: "Morgenroutine nur an Arbeitstagen" },
  "recipe.workdays_only_morning.when": { it: "Con l'integrazione Workday di Home Assistant", en: "With the Home Assistant Workday integration", fr: "Avec l'intégration Workday de Home Assistant", de: "Mit der Workday-Integration von Home Assistant" },
  "recipe.workdays_only_morning.howto": { it: "Accende la presa (macchina del caffè, luce del bagno) alle 6:30 dal lunedì al venerdì, ma la regola salta il blocco quando binary_sensor.workday_sensor è off: i festivi li conosce già l'integrazione Workday. Vale per qualsiasi entità on/off: un calendario, una persona (home/not_home), un interruttore virtuale.", en: "Turns the plug on (coffee machine, bathroom light) at 6:30 Monday to Friday, but the rule skips the block when binary_sensor.workday_sensor is off: the Workday integration already knows the public holidays. Works with any on/off entity: a calendar, a person (home/not_home), an input boolean.", fr: "Allume la prise (machine à café, lumière de la salle de bain) à 6h30 du lundi au vendredi, mais la règle saute le bloc quand binary_sensor.workday_sensor est off : l'intégration Workday connaît déjà les jours fériés. Fonctionne avec toute entité on/off : un calendrier, une personne (home/not_home), un booléen.", de: "Schaltet die Steckdose (Kaffeemaschine, Badlicht) montags bis freitags um 6:30 ein, die Regel überspringt den Block aber, wenn binary_sensor.workday_sensor off ist: die Workday-Integration kennt die Feiertage bereits. Funktioniert mit jeder Ein/Aus-Entität: Kalender, Person (home/not_home), Input Boolean." },
  "recipe.workdays_only_morning.preset_name": { it: "Mattino nei giorni lavorativi", en: "Workday mornings", fr: "Matins ouvrés", de: "Arbeitstag-Morgen" },
  "recipe.solar_surplus_boiler.title": { it: "Scaldacqua solo con batteria carica", en: "Water heater only on a full battery", fr: "Chauffe-eau seulement batterie pleine", de: "Warmwasser nur bei voller Batterie" },
  "recipe.solar_surplus_boiler.when": { it: "Fotovoltaico con accumulo", en: "Solar with battery storage", fr: "Photovoltaïque avec batterie", de: "Photovoltaik mit Speicher" },
  "recipe.solar_surplus_boiler.howto": { it: "Il blocco 10-16 scalda solo se la batteria è sopra l'80%: la regola salta il blocco sotto quella soglia. Sostituisci sensor.battery_soc con il sensore del tuo accumulo.", en: "The 10-16 block only heats when the battery is above 80%: the rule skips the block below that. Replace sensor.battery_soc with your own storage sensor.", fr: "Le bloc 10-16 ne chauffe que si la batterie dépasse 80 % : la règle ignore le bloc en dessous. Remplacez sensor.battery_soc par le capteur de votre batterie.", de: "Der Block 10-16 heizt nur bei über 80 % Batterie: darunter überspringt die Regel den Block. sensor.battery_soc durch den eigenen Speichersensor ersetzen." },
  "recipe.solar_surplus_boiler.preset_name": { it: "Scaldacqua surplus FV", en: "Water heater PV surplus", fr: "Chauffe-eau surplus PV", de: "Warmwasser PV-Überschuss" },
  ...
  "recipe.vacuum_weekday_morning.when": { it: "Pulizia alle 10:00 dal lunedì al venerdì, quando la casa è vuota. Nessuna regola: solo maschera giorni.", en: "Cleaning at 10:00 Monday to Friday, while the house is empty. No rules: just the day mask.", fr: "Nettoyage à 10h du lundi au vendredi, quand la maison est vide. Pas de règle : juste le masque des jours.", de: "Reinigung um 10:00 Montag bis Freitag, wenn das Haus leer ist. Keine Regeln: nur die Tagesmaske." },
  ...
  "help.glossary.rule.title": { it: "Regola", en: "Rule", fr: "Règle", de: "Regel" },
  ...
  "weather.attr.price.now": { it: "Prezzo elettricità adesso", en: "Electricity price now", fr: "Prix de l'électricité maintenant", de: "Strompreis jetzt" },
  "weather.attr.price.rank_today": { it: "Posizione prezzo oggi (1 = ora più economica)", en: "Price rank today (1 = cheapest hour)", fr: "Rang du prix aujourd'hui (1 = heure la moins chère)", de: "Preisrang heute (1 = günstigste Stunde)" },
  "weather.attr.price.vs_average_pct": { it: "Prezzo rispetto alla media di oggi", en: "Price vs today average", fr: "Prix par rapport à la moyenne du jour", de: "Preis im Vergleich zum Tagesmittel" },
  "weather.attr.illuminance": { it: "Luminosità (lux)", en: "Illuminance (lux)", fr: "Luminosité (lux)", de: "Beleuchtungsstärke (Lux)" },
  ...
  "action.thermostat.set_hvac_mode": { it: "Modalità HVAC", en: "HVAC mode", fr: "Mode CVC", de: "HVAC-Modus" },
  "action.thermostat.set_hvac_mode.value": { it: "Modalità", en: "Mode", fr: "Mode", de: "Modus" },
  ...
  "action.thermostat.auto_off": { it: "Spegnimento automatico", en: "Auto-off", fr: "Arrêt automatique", de: "Auto-Abschaltung" },
  "action.light.auto_off": { it: "Spegnimento automatico", en: "Auto-off", fr: "Arrêt automatique", de: "Auto-Abschaltung" },
  "action.plug.auto_off": { it: "Spegnimento automatico", en: "Auto-off", fr: "Arrêt automatique", de: "Auto-Abschaltung" },
  "action.fan.auto_off": { it: "Spegnimento automatico", en: "Auto-off", fr: "Arrêt automatique", de: "Auto-Abschaltung" },
  ...
  "editor.delete.warn": { it: "Operazione non reversibile. La schedulazione, i blocchi e le regole associate verranno eliminati.", en: "This cannot be undone. The schedule, its blocks and its rules will be deleted.", fr: "Action irréversible. La planification, ses créneaux et ses règles seront supprimés.", de: "Nicht umkehrbar. Der Zeitplan, seine Blöcke und Regeln werden gelöscht." },
  "editor.delete.summary": { it: "{blocks} fasce · {devices} dispositivi · {rules} regole", en: "{blocks} blocks · {devices} devices · {rules} rules", fr: "{blocks} créneaux · {devices} appareils · {rules} règles", de: "{blocks} Blöcke · {devices} Geräte · {rules} Regeln" },
  ...
  "history.kind.rule": { it: "Regola", en: "Rule", fr: "Règle", de: "Regel" },
  ...
  "history.outcome.warning": { it: "Avviso", en: "Warning", fr: "Avertissement", de: "Warnung" },
  ...
  "history.kpi.warnings": { it: "Avvisi", en: "Warnings", fr: "Avertissements", de: "Warnungen" },
  ...
  "history.chart.sub": { it: "Verde: ok · giallo: avvisi · rosso: errori", en: "Green: ok · yellow: warnings · red: errors", fr: "Vert : ok · jaune : avertissements · rouge : erreurs", de: "Grün: ok · gelb: Warnungen · rot: Fehler" },
